...
* 因此，UEditor提供了针对不同页面的编辑器可单独配置的根路径，具体来说，在需 要实例化编辑器的页面最顶部写上如下代码即可。当然，需要令此处的URL等于对应的配置。
...
,toolbars:[["Emotion","ForeColor","FontSize","BackColor","Bold","Underline","Italic","StrikeThrough"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'forecolor':'','fontsize':'','backcolor':'','emotion':'','snapscreen':'','bold':'','underline':'','italic':'','strikethrough':''}
